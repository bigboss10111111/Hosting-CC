      ...
      <CRow>
        <CCol xs>
          <CCard className="mb-4">
            <CCardHeader>Log Penduduk</CCardHeader>
            <CCardBody>
              <CTable align="middle" className="mb-0 border" hover responsive>
                <CTableHead className="text-nowrap text-center ">
                  <CTableRow>
                    ...
                    <CTableHeaderCell className="bg-body-tertiary">Keterangan</CTableHeaderCell>
                    <CTableHeaderCell className="bg-body-tertiary">Tanggal</CTableHeaderCell>
                  </CTableRow>
                </CTableHead>
